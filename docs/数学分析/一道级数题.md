...
24年6月，江苏省涟水中等专业学校17岁服装专业学生姜萍以**93分、全球第12名**的成绩晋级阿里巴巴全球数学竞赛公布决赛入围名单，从而引起热议。

![chem](../images/jiangping.jpg){ width="500" }
...
$$\displaystyle \psi^{(n)}(z)=(-1)^{n+1}n!\sum_{k=0}^{+\infty}{\frac{1}{(k+z)^{n+1}}}$$​
...
$$\displaystyle \psi'(1-z)+\psi'(z) = -\pi \frac{\mathrm d}{\mathrm dz} \cot \pi z$$​

$$\displaystyle \psi''(1-z)-\psi''(z) = \pi \frac{\mathrm d^2}{\mathrm dz^2} \cot \pi z$$
...
$$\displaystyle \sum_{k=-\infty}^{+\infty}{\frac{1}{(k\pi+z)^{2}}} = \frac{1}{\pi^2}\sum_{k=-\infty}^{+\infty}{\frac{1}{(k+\frac{z}{\pi})^{2}}}= \frac{1}{\pi^2}\sum_{k=-\infty}^{-1}{\frac{1}{(k+\frac{z}{\pi})^{2}}} + \frac{1}{\pi^2}\sum_{k=0}^{+\infty}{\frac{1}{(k+\frac{z}{\pi})^{2}}}$$ 
...
$$=\displaystyle \frac{1}{\pi^2}\sum_{k=0}^{+\infty}{\frac{1}{(k+1-\frac{z}{\pi})^{2}}}+ \frac{1}{\pi^2}\sum_{k=0}^{+\infty}{\frac{1}{(k+\frac{z}{\pi})^{2}}} $$ 
...
$$\displaystyle =\frac{1}{\pi^2}\left(\psi'(1-\frac{z}{\pi})+\psi'(\frac{z}{\pi})\right) =\frac{1}{\pi^2}\left(\pi^2\csc^2(\pi \cdot \frac{z}{\pi})\right) = \csc^2 z$$
...
根据$\displaystyle\frac{\sin x}{x}$的无穷乘积展开：



$$\displaystyle\frac{\sin x}{x}=\prod_{n=1}^{\infty}{\left(1-\frac{x^2}{(n\pi)^2}\right)}$$​
...
$$\displaystyle\cot x = \frac{1}{x}+\sum_{n=1}^{\infty}{\frac{2x}{x^2-(n\pi)^2}}=\sum_{n=-\infty}^{+\infty}{\frac{1}{x+n\pi}}$$​

由于：$(\cot x)' = -\csc^2 x$，对上式做$\displaystyle -\frac{\mathrm d}{\mathrm dx}$​，即得：

$$\displaystyle \csc^2 x = -\frac{\mathrm d}{\mathrm dx}\left(\sum_{n=-\infty}^{+\infty}{\frac{1}{x+n\pi}}\right)=\sum_{n=-\infty}^{+\infty}{\frac{1}{(x+n\pi)^2}}$$
...
$$\displaystyle \cot x = \frac{1}{x} + \frac{1}{\pi}\sum_{n=1}^{\infty}{\frac{2(\frac{x}{\pi})}{(\frac{x}{\pi})^2-n^2}} = \frac{1}{x}+\sum_{n=1}^{\infty}{\frac{2x}{x^2-(n\pi)^2}}$$

这样得到$\cot x$的展开式：

$$\displaystyle \cot x = \frac{1}{x}+\sum_{n=1}^{\infty}{\frac{2x}{x^2-(n\pi)^2}},\quad (x\neq 0,\pm\pi,\pm2\pi,\cdots)$$​

#### 求导，得到$\csc^2 x$的展开式

$$\displaystyle \csc^2 x = \sum_{n\in\mathbb Z}{\frac{1}{(x+n\pi)^2}},\quad (x\neq 0,\pm\pi,\pm2\pi,\cdots)$$

#### 令$x=0$，得到$\csc x$的展开式

$$\displaystyle \frac{\pi}{\sin a\pi} = \frac{1}{a}+\sum_{n=1}^{\infty}{(-1)^n \frac{2a}{a^2-n^2}},\quad a \notin \mathbb Z$$

同样的，让$a\pi = x$，同样$x\neq 0,\pm\pi,\pm2\pi,\cdots$，可得：

$$\displaystyle \csc x = \frac{1}{x}+\sum_{n=1}^{\infty}{(-1)^n\frac{2x}{x^2-(n\pi)^2}},\quad (x\neq 0,\pm\pi,\pm2\pi,\cdots)$$ 